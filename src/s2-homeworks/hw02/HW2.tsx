...
export const filterAffairs = (affairs: AffairType[], filter: FilterType) => affairs.filter(affair => affair.priority === filter || filter === 'all');

export const deleteAffair = (affairs: AffairType[], _id: number) => affairs.filter(affair => affair._id !== _id)
